...
//! фильтр на мобильных устройствая 
...
//! Показать-скрыть контет внутри виджетов
...
const topLocatonCheckboxes = document.querySelectorAll('[data-location-param]');

//! Выбор кнопки ЛЮБАЯ  и отключение других чекбоксов
checkBoxAny.addEventListener('change', function () {
  if (checkBoxAny.checked) {
    topLocatonCheckboxes.forEach(function (item) {
      item.checked = false;
    });
  }
})

//! Клик по другим кнопкам в location, отключаем кнопку ЛЮБАМЯ, при выборе других параметров
topLocatonCheckboxes.forEach(function (item) {
